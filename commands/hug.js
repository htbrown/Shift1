...
module.exports = async (client, message, args) => {
    ...
    client.util.embed(client, message, `*Awhh!* <@${message.author.id}> just hugged ${args[0]}!`, undefined, undefined, undefined, undefined, undefined, {url: 'https://media.giphy.com/media/od5H3PmEG5EVq/giphy.gif'})
}
module.exports.info = {
